...
export const NotionTooltip = ({ url }: NotionTooltipProps) => {
    return (
        <a
            ...
            className="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-card-soft hover:bg-cream border border-line hover:border-line-strong transition-all group"
        >
            <svg className="w-5 h-5 text-ink-soft group-hover:text-ink transition-colors" viewBox="0 0 24 24" fill="currentColor">
            ...
            <svg className="w-4 h-4 text-ink-soft/70 group-hover:text-ink-soft transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
