...
import { gitUrlT } from '@/features/project/types/project.types';
    ...
    return (
        <>
            {git.map((data: gitUrlT, index: number) => (
                ...
                >
                    <svg className="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors" viewBox="0 0 24 24" fill="currentColor">
