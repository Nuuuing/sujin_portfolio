...
export const projDetailData: projDetailT[] = [
    ...
    },
    {
        ...
        projContents: ["개발 4인, 기획 3인", "　", "협약 기업과 진행 시작하였으나 기업의 사정으로 인하여 협약이 무산 이슈!",
            ...
            "- GPGS LOGIN", "- SpringBoot, RestAPI", "- Apache + AddressableAssets", "- Nginx, React.js : 관리자 페이지", "- Docker, DockerCompose, AWS"],
        projTag: ["2D", "협약 프로젝트", "캐주얼", "퍼즐"],
        startDate: "2024.11.01",
        endDate: "2024.12",
        projSkills: [
    ...
    },
    {
        ...
        projContents: ["Team SORI (김수진, 전홍현)", "　", "SORI는 2인 창작 퍼즐/액션 아케이드 게임입니다.",
            ...
            "- ProBuilder를 통해 지형 구성 및 PolyBrush로 세부묘사 및 오브젝트 배치", "- 문장 보관함 및 단어 인벤토리 풀링",
            "- 상점 상호작용", "- 공통 Dialog, 비동기 로딩 Scene 전환"],
        projTag: ["3D", "Team", "2인", "창작", "캐주얼", "퍼즐", "아케이드"],
        startDate: "2024.08.28",
        endDate: "2024.10.04",
        projSkills: [
    ...
    },
    {
        ...
        projContents: ["4인 Team (전홍현, 박지훈, 김수진, 김수주)", "　", "퍼즐,협동 게임인 PICO PARK를 모작한 프로젝트 입니다.",
            ...
            "- 유저 정보 DB에 저장 및 로그인처리", "- Local Data. Json 관리", "- TCP - CLIENT 방목록 통신"],
        projTag: ["2D", "Team", "4인", "퍼즐", "네트워크"],
        startDate: "2024.08.12",
        endDate: "2024.08.19",
        projSkills: [
    ...
    },
    {
        ...
        projContents: ["4인 Team (전홍현, 박지훈, 김수진, 김수주)", "　", "생존/어드벤처 게임인 The Wild Eight을 모작한 프로젝트 입니다.",
            ...
            "- Json Data. Object Prefab 생성", "- Map Object 상호작용", "- Item 구조 설계 및 상태 변경, 감지 및 줍기",
    ...
    },
    {
        ...
        projContents: ["1인 프로젝트", "　", "퍼즐 게임인 Papers, Please를 모작한 프로젝트 입니다.",
            "여권과 신분증을 검토하여 진위 여부를 판단하고, 불법 입국자나 범죄자를 걸러내며 진행합니다.", "　",
            "- 시간흐름", "- Sprite Drag&Drop", "- 랜덤 정보 세팅", "- 검증 및 결과처리"],
        projTag: ["2D", "1인", "퍼즐", "여권 내라우!"],
        startDate: "2024.06.13",
        endDate: "2024.06.24",
        projSkills: [
